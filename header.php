...
<i class="fa fa-shopping-cart" aria-hidden="true"> <a class="nav-link text-white" href="cart.php" ><span id="cart" class="badge badge-warning mx-2"></span></a></i> Cart <span class="badge badge-pill badge-danger"></span>
